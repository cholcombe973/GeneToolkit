...
public class GUI extends JFrame {
  ...
  private JList focusOwner;                                // The reference to the JList focus owner.
  ...
  private void jbInit() throws Exception {
    ...
    pluginJList.addFocusListener(new FocusListener(){
    ...
    //we need a listener here to figure out what has been selected.
    //also, jlists might need to be connected together so that there is no confusion when two items are selected
    //at the same time and plugin info is selected from the menu.
    ...
    jMenuItem2.addActionListener(new ActionListener(){
      public void actionPerformed(ActionEvent e){
        ...
        //JOptionPane.showMessageDialog((GUI)re.getReference("GUI"),"Cursor: "+value,"Title",JOptionPane.INFORMATION_MESSAGE);
